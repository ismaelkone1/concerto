...
const repoRoot = process.env.MONOREPO_PATH || path.resolve(__dirname, "..", "..");

export class SprintManager {
  private stepsPath = path.resolve(repoRoot, "ai-dev-rules/steps.md");
  private detailsDir = path.resolve(repoRoot, "ai-dev-rules");
